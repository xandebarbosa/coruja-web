...
export const searchByGeoLocation =
  radarsService.searchByGeoLocation.bind(radarsService);
...
export const getLatestRadars =
  radarsService.getLatestRadars.bind(radarsService);
//export const getRadarsWithFilters = radarsService.getRadarsWithFilters.bind(radarsService);
export const searchAllByLocalForExport =
  radarsService.searchAllByLocalForExport.bind(radarsService);

export const getMonitoredPlates =
  monitoringService.getMonitoredPlates.bind(monitoringService);
export const createMonitoredPlate =
  monitoringService.createMonitoredPlate.bind(monitoringService);
export const updateMonitoredPlate =
  monitoringService.updateMonitoredPlate.bind(monitoringService);
export const deleteMonitoredPlate =
  monitoringService.deleteMonitoredPlate.bind(monitoringService);
export const getAlerts = monitoringService.getAlerts.bind(monitoringService);
export const getAlertHistory =
  monitoringService.getAlertHistory.bind(monitoringService);

export const searchLogs = logsService.searchLogs.bind(logsService);
export const analisarPlacaComIA =
  analysisService.analyzeConvoy.bind(analysisService);

export const deleteUserTelegram =
  TelegramService.deleteOne.bind(TelegramService);
