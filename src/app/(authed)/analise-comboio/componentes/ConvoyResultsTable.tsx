...
import SignpostIcon from "@mui/icons-material/Signpost"; // Novo ícone para Locais
...
// 🔹 ATUALIZADO: Agora são 7 colunas (adicionamos "Locais Distintos")
const TOTAL_COLS = 7;
    ...
    <React.Fragment>
      ...
      >
        ...
        <TableCell align="center">
          ...
          >
            <SignpostIcon sx={{ color: "#4b5563", fontSize: 16 }} />
            <Typography
              variant="body2"
              sx={{ fontWeight: 600, color: "#4b5563" }}
            >
              {row.quantidadeLocaisDistintos ?? "—"} locais
            </Typography>
          </Box>
        </TableCell>
        ...
        <TableCell align="center">
          <Chip
            label={`${row.quantidadeEncontros} vez${row.quantidadeEncontros !== 1 ? "es" : ""}`}
            size="small"
            sx={{
              bgcolor:
                row.quantidadeEncontros >= 3
                  ? "rgba(220,38,38,0.1)"
                  : "rgba(245,158,11,0.1)",
              color: row.quantidadeEncontros >= 3 ? "#dc2626" : "#d97706",
              fontWeight: 600,
              border: "1px solid",
              borderColor:
                row.quantidadeEncontros >= 3
          ...
          <Collapse in={open} timeout="auto" unmountOnExit>
            ...
            >
              ...
              >
                ...
                >
                  Detalhes dos {row.quantidadeEncontros} Encontros
                </Typography>
              </Box>
              ...
              <Box sx={{ overflowX: "auto", WebkitOverflowScrolling: "touch" }}>
                ...
                >
                  ...
                  <TableBody>
                    {row.encontros?.map((encontro, idx) => (
                      <TableRow
                        key={idx}
                        sx={{
                      ...
                      >
                        ...
                        >
                          {/* 🔹 ATUALIZADO: Mostrando a Praça em vez da Rodovia para facilitar a identificação do local exato */}
                          {encontro.praca || encontro.rodovia}
...
export default function ConvoyResultsTable({
  resultados,
}: ConvoyResultsTableProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {resultados.length} veículo{resultados.length !== 1 ? "s" : ""}{" "}
          suspeito{resultados.length !== 1 ? "s" : ""}
        </Typography>
          ...
          <TableHead sx={{ bgcolor: "#14213d" }}>
            <TableRow>
              ...
              {[
                ...
                <TableCell
                  key={col}
                  align={i >= 4 ? "center" : "left"} // Centraliza as duas últimas colunas
                  sx={{
                    fontWeight: 700,
                    color: i === 5 ? "#fca311" : "white",
                    whiteSpace: "nowrap",
                    fontSize: "13px",
                    textTransform: "uppercase",
                    letterSpacing: "0.5px",
